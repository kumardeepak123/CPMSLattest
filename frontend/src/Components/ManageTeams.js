...
const ManageTeams = () => {
    ...
    const loadTeams=async()=>{
        await fetch(`https://localhost:44327/api/Team/all-teams`,{
            //   headers:{
    ...
    const loadEmployees=async()=>{
       await  fetch(`https://localhost:44327/api/Employee/employees`,{
        //   headers:{
        //       "Authorization" : `Bearer ${user.token}`
        //   }
       })
    ...
    const deleteEmployee=(employeeId,employeeName)=>{
        if(!window.confirm("Do you really want to delete?")){
          return;
            ...
            fetch(`https://localhost:44327/api/Employee/delete-employee/${employeeId}`,{
              method:'DELETE',
            //   headers:{
            //     Authorization:`Bearer ${user.token}`
            //   }
